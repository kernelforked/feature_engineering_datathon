...
\begin{itemize}
    \item \textbf{Calibration}: Tree-based predictions are calibrated using strictly monotonic \textbf{Logistic Regression (Platt Scaling)} to map rank blends back to probabilities while preserving continuous ranking granularity and preventing value collapsing.
